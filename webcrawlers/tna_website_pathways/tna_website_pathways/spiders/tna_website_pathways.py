...
from tna_website_pathways.items import TnaWebsiteItem, starturls, allowurls, denyurls
from tna_website_pathways.helpers import getDescription, getKeywords
from scrapy.loader import ItemLoader


class TnaWebsiteWebCrawler(CrawlSpider):
    name = 'tna_website_pathways'
