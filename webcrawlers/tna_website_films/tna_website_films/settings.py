...
# Scrapy settings for tna_website_films project
#
...
BOT_NAME = 'tna_website_films'

SPIDER_MODULES = ['tna_website_films.spiders']
NEWSPIDER_MODULE = 'tna_website_films.spiders'
...
# ITEM_PIPELINES = {'tna_website_films.pipelines.MongoDBPipeline': 100}

ITEM_PIPELINES = {'scrapyelasticsearch.scrapyelasticsearch.ElasticSearchPipeline': 100}

# ITEM_PIPELINES = {'scrapyelasticsearch.scrapyelasticsearch.ElasticSearchPipeline': 100,
#                   'tna_website_films.pipelines.MongoDBPipeline': 200}

"MONGODB PIPELINE SETTINGS"
MONGODB_SERVER = "localhost"
MONGODB_PORT = 27017
MONGODB_DB = 'tna_webcrawlers'
MONGODB_COLLECTION = 'tna_website_films'
MONGODB_UNIQ_KEY = 'ID'
