...
from tna_website_education.items import TnaWebsiteItem, starturls, allowurls, denyurls
from tna_website_education.helpers import parse_description, parse_keywords
from scrapy.loader import ItemLoader


class TnaWebsiteWebCrawler(CrawlSpider):
    handle_httpstatus_list = [301, 404]
    name = 'tna_website_education'
