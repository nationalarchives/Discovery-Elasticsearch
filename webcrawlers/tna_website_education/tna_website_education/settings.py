...
# Scrapy settings for tna_website_education project
#
...
BOT_NAME = 'tna_website_education'

SPIDER_MODULES = ['tna_website_education.spiders']
NEWSPIDER_MODULE = 'tna_website_education.spiders'
...
# ITEM_PIPELINES = {'tna_website_education.pipelines.MongoDBPipeline': 100}

ITEM_PIPELINES = {'scrapyelasticsearch.scrapyelasticsearch.ElasticSearchPipeline': 100}

# ITEM_PIPELINES = {'scrapyelasticsearch.scrapyelasticsearch.ElasticSearchPipeline': 100,
#                  'tna_website_education.pipelines.MongoDBPipeline': 200}

"MONGODB PIPELINE SETTINGS"
MONGODB_SERVER = "localhost"
MONGODB_PORT = 27017
MONGODB_DB = 'tna_webcrawlers'
MONGODB_COLLECTION = 'tna_website_education_coldwar'
MONGODB_UNIQ_KEY = 'ID'
